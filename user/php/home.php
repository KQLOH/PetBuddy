...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .category-icon-new { display: flex; align-items: center; justify-content: center; }
        ...
        /* 注意：如果 8 个分类，建议把 First Card 特殊样式去掉，保持整齐。如下已注释掉 */
        /* .category-card-new:first-child { grid-column: span 2; grid-row: span 2; height: auto; background: linear-gradient(135deg, #FFE8D1 0%, #FFF5EC 100%); border: none; }
        .category-card-new:first-child .category-icon-wrapper { width: 140px; height: 140px; }
        .category-card-new:first-child .category-icon-new img { width: 80px; height: 80px; }
        .category-card-new:first-child .category-name-new { font-size: 28px; margin-bottom: 15px; } 
        */
        ...
        .rank-badge {
            ...
            z-index: 2; box-shadow: 0 4px 10px rgba(0,0,0,0.15);
        ...
        /* 销量显示 */
        .p-sold {
            font-size: 12px; color: #888; margin-bottom: 5px; display: flex; align-items: center; gap: 4px;
        }
        ...
        .btn-heart-action:hover { border-color: #FFB774; color: #FFB774; background: #fff9f4; transform: translateY(-2px); }
        .btn-heart-action.active { border-color: #ff4d4d; color: #ff4d4d; background: #fff0f0; }
        ...
        @media (max-width: 640px) { 
            ...
            .hero-image-slider { height: 350px; }
            .main-slider-nav { width: 40px; height: 40px; font-size: 16px; }
            .category-card-new { height: 220px; }
...
<section class="hero-section">
    <div class="float-element float-1">
        <img src="../images/happy.png" alt="Happy Pet">
    </div>
    <div class="float-element float-2">
        <img src="../images/cat.png" alt="Happy Pet">
    </div>
    <div class="float-element float-3">
        <img src="../images/pawprints1.png" alt="Happy Pet">
    </div>
    ...
    <div class="features-container">
        <div class="feature-card">
            <div class="feature-icon">
                <img src="../images/fast-delivery.png" alt="Shipping">
            </div>
