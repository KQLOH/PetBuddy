...
<head>
    ...
    <style>
        ...
        * {
        ...
        .address-selector-wrapper label {
            font-weight: 600;
            color: var(--primary-dark);
            margin-bottom: 8px;
            display: flex;
        ...
        .address-selector-wrapper select {
        ...
        .payment-header-row input[type="radio"] {
            display: none;
        }
...
<body>
    ...
    <div class="checkout-layout">
        ...
        <div class="sidebar-col">
            ...
            <a href="cart.php" class="return-cart">
                < Return to cart</a>
        </div>
        ...
        $(document).ready(function() {
            ...
            $(".btn-apply").click(function(e) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        alert("System error applying voucher");
                    }
                });
            });
