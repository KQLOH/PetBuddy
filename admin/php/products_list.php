...
// ===== DATABASE CONNECTION =====
require_once '../user/include/db.php'; // Uses the $pdo variable from your db.php

$adminName = $_SESSION['full_name'] ?? 'Admin';

// ===== FETCH CATEGORIES FROM DATABASE =====
$categories = [];
$catSql = "SELECT category_id, name FROM product_categories ORDER BY name ASC";
...
// Note: No need for manual $stmt->close() in PDO, as it cleans up when the variable is overwritten or the script ends.
?>
<!DOCTYPE html>
<html lang="en">
